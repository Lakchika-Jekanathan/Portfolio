  ...
  <section className="h-full">
    <div className="container mx-auto h-full">
      ...
      <div className="text-left xl:text-left">
        ...
        <h1 className="h1 mb-6">Hello i'm <br/> <span className="text-accent-hover">Lakchika Jekanathan</span></h1>

        <p className="max-w-[500px] mb-6 text-white/70 leading-snug">Passionate software development with a knack for creating innovative solutions. My enthusiasm for tackling new challenges and collaborating with dynamic teams drives me to deliver impactful results.</p>
